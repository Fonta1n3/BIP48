...
multi-signature addresses are produced via public keys in a deterministic order.

This greatly reduces the friction in multi-signature use as users no longer need to
think about sorting their public keys.
